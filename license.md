...
This license is granted to a single legal entity ("Licensee") and permits
the use of the software for internal business purposes only, without
restriction on the number of WiseCP installations or domains operated
by the Licensee.

The license includes twelve (12) months of software updates from the
